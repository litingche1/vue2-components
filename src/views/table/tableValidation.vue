<template>
  <div class="table-validation-con">
    <h3>表格校验</h3>
    <p>1. updateStatus方法非常重要</p>
    <p>
      2. validate方法 如果你传入一个row，或者rows rows就是多个row的意思，
      那么就代表指定某行校验！
    </p>
    <p>
      <a
        href="https://github.com/u-leo/umy-ui/blob/master/examples/pages/umycomponent/tableRules.vue"
        target="_blank"
        >点击查看当前demo页面的代码</a
      >
    </p>
    <p>
      ...
      <el-button @click="$refs.plxTable.removeCheckboxRow()"
        >删除选中</el-button
      >
